...
import {
  ...
  RefreshControl, ScrollView, SafeAreaView, Platform,
} from "react-native";
...
class EventDetail extends Component {
  ...
  async _fetchNewDetails() {
    let {userID,event_id} = this.state;
    await Axios.get(`${SERVER_URL}?action=getEventUsers&event_id=${event_id}&user_id=${userID}`)
      .then(res => {
